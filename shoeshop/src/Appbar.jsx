    ...
    <div style={{ display: "flex" }}>
        ...
        <div style={{ justifyContent: "space-around" }}>
          <button style={{ borderRadius: "50%" }}>
            <img
              ...
              src="https://image.shutterstock.com/image-vector/o-4-dot-circle-logo-260nw-2082891655.jpg"
              alt="image"
            />
          </button>
        </div>
      ...
      <div>
        <ul style={{ display: "flex", paddingLeft: "0px" }}>
          <li>
            <a href="http://localhost:5173/shophub/">Home</a>
          </li>
          <li>
            <a href="http://localhost:5173/shophub/shop/">Shop</a>
          </li>
          <li>
            <a href="http://localhost:5173/shophub/blog/">Blog</a>
          </li>
          <li>
            <a href="http://localhost:5173/shophub/contact/">Contact</a>
          </li>
          <li>
            <a href="http://localhost:5173/shophub/myaccount/">My Account</a>
          </li>
        </ul>
      </div>
      <div style={{ display: "flex" }}>
